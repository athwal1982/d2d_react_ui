...
import BizClass from "./VLEPerformance.module.scss";

function VLEPerformance() {
  ...
  return (
    <div className={BizClass.PageStart}>
      ...
      <DataGrid rowData={filteredTicketHistoryDataList} loader={isLoadingTicketHistoryDataList ? <Loader /> : false} onGridReady={onGridReady}>
        ...
        <DataGrid.Column field="#" headerName="CSCID" width="110px" />
        <DataGrid.Column field="#" headerName="VLE Name" width="190px" />
        <DataGrid.Column field="#" headerName="Service Request Recieved" width="200px" cellStyle={{ "text-align": "right" }} />
        <DataGrid.Column field="#" headerName="Service Request Submitted" width="210px" cellStyle={{ "text-align": "right" }} />
        <DataGrid.Column field="#" headerName="Service Request Discard" width="190px" cellStyle={{ "text-align": "right" }} />
        <DataGrid.Column field="#" headerName="Service Request Pending" width="190px" cellStyle={{ "text-align": "right" }} />
        <DataGrid.Column field="#" headerName="Submission Rate" width="145px" cellStyle={{ "text-align": "right" }} />
      </DataGrid>
    </div>
  );
}

export default VLEPerformance;
