...
import BizClass from "./ServiceDiscard.module.scss";

function ServiceDiscard() {
  ...
  return (
    <div className={BizClass.PageStart}>
      ...
      <DataGrid rowData={filteredTicketHistoryDataList} loader={isLoadingTicketHistoryDataList ? <Loader /> : false} onGridReady={onGridReady}>
        ...
        <DataGrid.Column field="#" headerName="Sub Department" width="225px" />
        ...
        <DataGrid.Column field="#" headerName="Discarded by" width="160px" />
        <DataGrid.Column field="#" headerName="Appointment Date" width="155px" />
        <DataGrid.Column field="#" headerName="Discard Reason" width="180px" />
        <DataGrid.Column field="#" headerName="Remarks" width="260px" />
      </DataGrid>
    </div>
  );
}

export default ServiceDiscard;
