...
import BizClass from "./ServiceRequest.module.scss";
  ...
  return (
    <div className={BizClass.PageStart}>
      ...
      <DataGrid rowData={filteredTicketHistoryDataList} loader={isLoadingTicketHistoryDataList ? <Loader /> : false} onGridReady={onGridReady}>
        ...
        <DataGrid.Column field="#" headerName="Mode" width="110px" />
        <DataGrid.Column field="#" headerName="Customer Name" width="190px" />
        <DataGrid.Column field="#" headerName="Mobile No" width="120px" />
        <DataGrid.Column field="#" headerName="Service Request ID" width="160px" />
        <DataGrid.Column field="#" headerName="Created Date" width="125px" />
        <DataGrid.Column field="#" headerName="Created by" width="160px" />
        <DataGrid.Column field="#" headerName="Appointment Date" width="155px" />
        <DataGrid.Column field="#" headerName="Service Request Status" width="185px" />
        <DataGrid.Column field="#" headerName="Status Date" width="125px" />
        <DataGrid.Column field="#" headerName="Address" width="145px" />
        <DataGrid.Column field="#" headerName="District" width="145px" />
        <DataGrid.Column field="#" headerName="City" width="145px" />
        <DataGrid.Column field="#" headerName="Pincode" width="145px" />
        <DataGrid.Column field="#" headerName="Department" width="225px" />
        <DataGrid.Column field="#" headerName="Name of Service" width="225px" />
        <DataGrid.Column field="#" headerName="Gov. Fee" width="125px" cellStyle={{ "text-align": "right" }} />
        <DataGrid.Column field="#" headerName="Payment Mode" width="145px" />
        <DataGrid.Column field="#" headerName="Vendor Fees" width="125px" cellStyle={{ "text-align": "right" }} />
        <DataGrid.Column field="#" headerName="Consolidated Tax" width="145px" cellStyle={{ "text-align": "right" }} />
        <DataGrid.Column field="#" headerName="Receipt No" width="145px" />
        <DataGrid.Column field="#" headerName="VLE Name" width="145px" />
        <DataGrid.Column field="#" headerName="VLE Area" width="145px" />
        <DataGrid.Column field="#" headerName="Aplication No. Gov." width="175px" />
        <DataGrid.Column field="#" headerName="If Discard,Reason" width="145px" />
        <DataGrid.Column field="#" headerName="Total" width="100px" cellStyle={{ "text-align": "right" }} />
      </DataGrid>
    </div>
  );
}
